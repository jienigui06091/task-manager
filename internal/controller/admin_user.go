...
func Register(c *gin.Context) {
	...
	reqAdminuser, err := service.RegisterAdminUser(c.Request.Context(), username, password)
	if err != nil {
		var dbErr sqlStateError
...
func Login(c *gin.Context) {
	...
	token, err := service.LoginAdminUser(c.Request.Context(), req.Username, req.Password)
	if err != nil {
...
func GetAdminUserPage(c *gin.Context) {
	...
	users, total, err := service.GetAdminUsers(c.Request.Context(), iPage, iPageSize)
	if err != nil {
		_ = c.Error(err)
		return
	}
